...
'GPU_INDEXED_TUPLE_RECONSTRUCTION_1/measurement_pairs.data' using 1:2 title "GPU_INDEXED_TUPLE_RECONSTRUCTION_1 measured execution times" with points, \
'GPU_INDEXED_TUPLE_RECONSTRUCTION_1/measurement_pairs.data' using 1:3 title "GPU_INDEXED_TUPLE_RECONSTRUCTION_1 estimated execution times" with points
